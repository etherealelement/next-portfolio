    ...
    return <>
        <svg width="80" height="60" viewBox="0 0 80 60" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g style={{mixBlendMode: "saturation"}}>
                <path d="M70.864 24.5365C74.8361 26.8135 74.8948 32.5224 70.9704 34.8833L49.5805 47.7513C45.6051 50.1429 40.5369 47.3125 40.4893 42.6741L40.2294 17.396C40.1817 12.7575 45.1906 9.8199 49.2143 12.1264L70.864 24.5365Z" fill="#0DFFFF"/>
            </g>
